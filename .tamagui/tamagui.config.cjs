...
var require_createAnimations = __commonJS({
  "node_modules/@tamagui/animations-css/dist/cjs/createAnimations.js"(exports, module2) {
    ...
    function createAnimations2(animations2) {
      return {
        View: import_core56.Stack,
        Text: import_core56.Text,
        animations: animations2,
        usePresence: import_use_presence2.usePresence,
        supportsCSSVars: true,
        useAnimatedNumber(initial) {
          const [val, setVal] = (0, import_react44.useState)(initial);
          return {
            getInstance() {
              return val;
            },
        ...
        useAnimatedNumberReaction({ hostRef, value }, onValue) {
          (0, import_core56.useIsomorphicLayoutEffect)(() => {
            if (!hostRef.current)
              return;
        ...
        useAnimations: ({ props, presence, style, componentState, hostRef }) => {
          ...
          return (0, import_core56.useIsomorphicLayoutEffect)(() => {
    ...
    var createInterFont2 = /* @__PURE__ */ __name((font = {}, {
      ...
      return (0, import_core56.createFont)({
        ...
        lineHeight: Object.fromEntries(
          Object.entries(size3).map(([k, v]) => [k, sizeLineHeight((0, import_core56.getVariableValue)(v))])
        ),
        weight: {
          4: "300"
        },
...
var require_cjs4 = __commonJS({
  "node_modules/@tamagui/font-silkscreen/dist/cjs/index.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_core56 = require("@tamagui/core");
    var createSilkscreenFont2 = /* @__PURE__ */ __name((font = {}) => (0, import_core56.createFont)({
      family: import_core56.isWeb ? "Silkscreen, Fira Code, Monaco, Consolas, Ubuntu Mono, monospace" : "Silkscreen",
      size: size3,
      lineHeight: Object.fromEntries(
...
var require_AnimatePresence = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/AnimatePresence.js"(exports, module2) {
    ...
    var AnimatePresence2 = /* @__PURE__ */ __name(({
      ...
      const isClientMounted = (0, import_web18.useDidFinishSSR)(), forceRenderLayoutGroup = (0, import_react44.useContext)(import_LayoutGroupContext2.LayoutGroupContext).forceRender;
...
var require_Collapsible = __commonJS({
  "node_modules/@tamagui/collapsible/dist/cjs/Collapsible.js"(exports, module2) {
    ...
    var import_animate_presence5 = require_cjs7();
...
var require_Collection = __commonJS({
  "node_modules/@tamagui/collection/dist/cjs/Collection.js"(exports, module2) {
    ...
    var import_compose_refs18 = require_cjs11();
    var import_core56 = require("@tamagui/core");
    var import_react44 = __toESM2(require("react"));
    var import_jsx_runtime52 = require("react/jsx-runtime");
...
var require_cjs14 = __commonJS({
  "node_modules/@tamagui/get-button-sized/dist/cjs/index.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_get_token12 = require_cjs13();
  ...
  "node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var getFontSizeToken = /* @__PURE__ */ __name((inSize, opts) => {
      if (typeof inSize == "number")
        return null;
      const relativeSize = (opts == null ? void 0 : opts.relativeSize) || 0, fontSize = (0, import_core56.getConfig)().fontsParsed[(opts == null ? void 0 : opts.font) || "$body"].size, size3 = inSize || ("$true" in fontSize ? "$true" : "$4"), sizeTokens = Object.keys(fontSize);
...
var require_validStyleProps = __commonJS({
  "node_modules/@tamagui/helpers/dist/cjs/validStyleProps.js"(exports, module2) {
    ...
    var import_constants13 = require_cjs24();
...
var require_Group = __commonJS({
  "node_modules/@tamagui/group/dist/cjs/Group.js"(exports, module2) {
    ...
    var import_core56 = require("@tamagui/core");
    var import_create_context12 = require_cjs29();
    var import_stacks26 = require_cjs15();
    var import_use_controllable_state15 = require_cjs9();
    var import_react44 = __toESM2(require("react"));
    var import_react_native14 = require("react-native-web-lite");
    ...
    function createGroup(verticalDefault) {
      return (0, import_core56.withStaticProperties)(
        (0, import_react44.forwardRef)((props, ref) => {
          ...
          }), isUsingItems = itemChildrenCount > 0, radius2 = borderRadius ?? (size3 ? (0, import_core56.getVariableValue)((0, import_core56.getTokens)().radius[size3]) - 1 : void 0), disablePassBorderRadius = disablePassBorderRadiusProp ?? !(radius2 !== void 0), childrenArray = import_react44.Children.toArray(childrenProp), children = isUsingItems ? import_react44.Children.toArray(childrenProp).filter(import_react44.isValidElement) : childrenArray.map((child, i) => {
...
var require_ListItem = __commonJS({
  "node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_font_size4 = require_cjs23();
    var import_get_font_sized4 = require_cjs16();
    var import_get_token12 = require_cjs13();
    var import_helpers_tamagui4 = require_cjs27();
    var import_stacks26 = require_cjs15();
    var import_text8 = require_cjs17();
    var import_web18 = require("@tamagui/core");
    var import_jsx_runtime52 = require("react/jsx-runtime");
    var NAME3 = "ListItem";
    var ListItemFrame2 = (0, import_web18.styled)(import_stacks26.ThemeableStack, {
      name: NAME3,
      tag: "li",
      variants: {
        unstyled: {
    ...
    var ListItemText = (0, import_web18.styled)(import_text8.SizableText, {
      name: "ListItemText",
      variants: {
        unstyled: {
          false: {
        ...
        props: {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)(import_jsx_runtime52.Fragment, { children: [
            themedIcon ? /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)(import_jsx_runtime52.Fragment, { children: [
              themedIcon,
              /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(import_web18.Spacer, { size: spaceSize })
            ] }) : null,
...
var import_image = __toESM(require_cjs22());
...
var Avatar = (0, import_core18.withStaticProperties)(
  React13.forwardRef(
    (props, forwardedRef) => {
      const { __scopeAvatar, size: size3 = "$true", ...avatarProps } = props, [imageLoadingStatus, setImageLoadingStatus] = React13.useState("idle");
...
var import_font_size = __toESM(require_cjs23());
var import_get_button_sized2 = __toESM(require_cjs14());
var import_helpers_tamagui = __toESM(require_cjs27());
...
var import_font_size2 = __toESM(require_cjs23());
var import_get_token = __toESM(require_cjs13());
var import_helpers_tamagui2 = __toESM(require_cjs27());

// node_modules/@tamagui/label/dist/esm/Label.js
var import_focusable = __toESM(require_cjs28());
...
var LabelComponent = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return import_web13.isWeb && React14.useEffect(() => {
      if (htmlFor) {
...
var PopperContent = React17.forwardRef(function(props, forwardedRef) {
  const { __scopePopper, ...rest } = props, { strategy, placement, refs, x, y, getFloatingProps, size: size3, isMounted, update } = usePopperContext(__scopePopper), contentRefs = useComposedRefs(refs.setFloating, forwardedRef), contents = React17.useMemo(() => /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
    PopperContentFrame,
    {
...
function PopoverContentPortal(props) {
  ...
  return (import_react_native8.Platform.OS === "android" || import_react_native8.Platform.OS === "ios") && (contents = /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(PopoverRepropagateContext, { popperContext, context, children: props.children })), /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Portal, { zIndex: zIndex2, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(import_core24.Theme, { name: themeName, children: [
...
var SelectContent = /* @__PURE__ */ __name(({
  ...
  const context = useSelectContext(CONTENT_NAME3, __scopeSelect), itemParentContext = useSelectItemParentContext(CONTENT_NAME3, __scopeSelect), themeName = (0, import_core29.useThemeName)(), showSheet = useShowSelectSheet(context), contents = /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_core29.Theme, { forceClassName: true, name: themeName, children }), touch = (0, import_core29.useIsTouchDevice)(), overlayStyle = (0, import_react33.useMemo)(() => ({ zIndex: zIndex2, pointerEvents: context.open ? "auto" : "none" }), [context.open]);
  ...
  (props, forwardedRef) => {
    const { __scopeSelect, ...groupProps } = props, groupId = React27.useId(), context = useSelectContext(GROUP_NAME, __scopeSelect), itemParentContext = useSelectItemParentContext(GROUP_NAME, __scopeSelect), size3 = itemParentContext.size ?? "$true", nativeSelectRef = React27.useRef(null), content = function() {
      return itemParentContext.shouldRenderWebNative ? (
        ...
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(NativeSelectFrame, { asChild: true, size: size3, value: context.value, children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
...
var SliderFrame = (0, import_core36.styled)(YStack, {
  ...
  variants: {
    ...
    size: (val, extras) => {
      if (!val)
        return;
      const orientation = extras.props.orientation, size3 = Math.round((0, import_core36.getVariableValue)((0, import_get_token6.getSize)(val)) / 6);
...
var SliderThumb = SliderThumbFrame.styleable(function(props, forwardedRef) {
  const { __scopeSlider, index: index3, size: sizeProp, ...thumbProps } = props, context = useSliderContext(THUMB_NAME, __scopeSlider), orientation = useSliderOrientationContext(THUMB_NAME, __scopeSlider), [thumb, setThumb] = React30.useState(null), composedRefs = useComposedRefs(
    forwardedRef,
    (node) => setThumb(node)
  ), value = context.values[index3], percent = value === void 0 ? 0 : convertValueToPercentage(value, context.min, context.max), label = getLabel(index3, context.values.length), sizeIn = sizeProp ?? context.size ?? "$true", [size3, setSize] = React30.useState(() => (0, import_core37.getVariableValue)(getThumbSize(sizeIn).width)), thumbInBoundsOffset = size3 ? getThumbInBoundsOffset(size3, percent, orientation.direction) : 0;
  React30.useEffect(() => {
    if (thumb)
...
var import_focusable2 = __toESM(require_cjs28());
...
var import_group = __toESM(require_cjs30());
...
var TabsTrigger = TabsTriggerFrame.extractable(
  React34.forwardRef(
    (props, forwardedRef) => {
      ...
      }, [isSelected, value, layout]), /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(import_web14.Theme, { name: isSelected ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
...
var import_focusable3 = __toESM(require_cjs28());
var import_font_size3 = __toESM(require_cjs23());
var import_get_token9 = __toESM(require_cjs13());
var import_group2 = __toESM(require_cjs30());
var import_helpers_tamagui3 = __toESM(require_cjs27());
...
var ToggleGroup = (0, import_web16.withStaticProperties)(
  import_react39.default.forwardRef(
    (props, forwardedRef) => {
      ...
      if (import_web16.isWeb || import_react39.default.useEffect(() => {
        if (props.id)
...
var import_focusable4 = __toESM(require_cjs28());
...
var Spinner = YStack.extractable(
  (0, import_core52.themeable)(
    React38.forwardRef((props, ref) => {
      const { size: size3, color: colorProp, ...stackProps } = props, theme = (0, import_core52.useTheme)();
      let color2 = colorProp;
      return color2 && color2[0] === "$" && (color2 = (0, import_core52.variableToString)(theme[color2])), /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(import_react_native13.ActivityIndicator, { size: size3, color: color2 }) });
    }),
    {
...
// src/tamagui.config.ts
var colorThemeDefinition2 = /* @__PURE__ */ __name((colorName) => [
  {
    parent: "light",
    palette: colorName,
    template: "colorLight"
...
var themesBuilder2 = createThemeBuilder().addPalettes(palettes).addTemplates(templates).addMasks(masks).addMasks({
